...
\CRANpkg{ppseq} package for the R software language \citep{RCT2020},
...
predictive probability monitoring design using the \CRANpkg{ppseq}
package. While the \CRANpkg{ppseq} package was developed with early
...
interactive visualizations, or the \code{plotly = FALSE} option to
...
\code{one\_sample\_decision\_tbl} included in the \CRANpkg{ppseq}
