...
We are sorry that the article in it's original form was difficult to follow. We hope the changes have made it more understandable, and that all of the needed detail is now included. Thank you for taking the time to conduct such a thorough review of our paper, we do believe that it has been improved as a result. Please see our detailed responses below.
